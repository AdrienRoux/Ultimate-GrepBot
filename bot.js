if (location.host.indexOf("grepolis.com", location.host.length - "grepolis.com".length) !== -1) {
    ...
    (function () {
        var ctx = { hash: "gm_", domain: "botsoft.org" };
        ...
        var bot = (ctx.bot = {
            ...
            inject: function () {
                ...
                if (
                    !(typeof Game === "undefined" || typeof WMap === "undefined" || typeof Layout === "undefined" || typeof $ === "undefined" || typeof angular === "undefined" || typeof world === "undefined") &&
                    path.substring(0, 6) !== "/forum"
                ) {
                    world = world ? world[1] : "unkn";
                    var that = this,
                        box = $("body");
                    if (box.length > 0) if ($("div#b9c5f5171msgs").length == 0) box.append('<div id="b9c5f5171msgs"></div>');
            ...
            settings: function () {
                var dlg = $("div#b9c5f5171bsettings"),
                    bot = this;
                if (dlg.length > 0) dlg.remove();
                else
                    bot.request("settings:get", {}, function (data) {
                        eval_ctx(data.result.js);
                    });
            },
            ajaxRequest: function (controller, action, params, callback, method, module) {
                ...
                if (!params) params = { town_id: Game.townId };
                ...
                obj = {
                    ...
                    error: function (_context, _data, _t_token) {
                        ...
                        if (_data.error) {
                            ...
                            ctx.log("debug", text);
                            bot.request("bot:log", { log: [{ type: "fail", text: text }] });
                        }
                    },
                };
            ...
            request: function (method, data, cb) {
                var that = this;
                var params = { key: that.key, method: method, data: data };
                $.post(
                    that.ajax,
                    JSON.stringify(params),
                    function (data) {
                        data = JSON.parse(data);
                        if (data.error && method != "bot:log") {
                        } else if (typeof cb == "function") cb(data);
                    },
                    "text"
                );
            },
        ...
        var lesscss = ["//botsoft.org/en/bot/bot.less?hash=b9c5f5171", "//botsoft.org/static/bot/css/gfbot.less?rand=" + Math.random(), "//botsoft.org/static/grepo/css/bot.less?=" + Math.random()];
        ...
        var js = [
            { name: "less", src: "//botsoft.org/static/js/less.min.js" },
            { name: "angular", src: "//botsoft.org/static/js/angular.min.js" },
        ];
