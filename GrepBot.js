...
var Autobot = {
    ...
    initWnd: function () {
        if (Autobot["isLogged"]) {
            ...
            _0x88b7x2["append"](
                $("<div/>", { class: "menu_wrapper", style: "left: 78px; right: 14px" })["append"](
                    $("<ul/>", { class: "menu_inner" })
    ...
    addMenuItem: function (_0x88b7x3, _0x88b7x4, _0x88b7x5) {
        return $("<li/>")["append"](
            $("<a/>", { class: "submenu_link", href: "#", id: "Autobot-" + _0x88b7x3, rel: _0x88b7x5 })
                ["click"](function () {
    ...
    contentAccount: function () {
        ...
        var _0x88b7xa = $("<table/>", { class: "game_table layout_main_sprite", cellspacing: "0", width: "100%" })["append"](function () {
            ...
            $["each"](accountInfo, function (_0x88b7xd, _0x88b7xe) {
                _0x88b7xc["append"](
                    $("<tr/>", { class: _0x88b7xb % 2 ? "game_table_even" : "game_table_odd" })
                        ["append"]($("<td/>", { style: "background-color: #DFCCA6;width: 30%;" })["html"](_0x88b7xd))
                        ["append"]($("<td/>")["html"](_0x88b7xe))
                );
                _0x88b7xb++;
            });
            return _0x88b7xc;
        ...
        _0x88b7xf += $("<div/>", { id: "grepobanner", style: "" })[0]["outerHTML"];
        return _0x88b7xf;
    },
    ...
    getPremium: function () {
        if (Autobot["isLogged"]) {
            ...
            var _0x88b7x14 = $("<div/>", { id: "payment" })
                ["append"](
                $("<div/>", { id: "left" })["append"](
                    $("<ul/>", { id: "time_options" })
                        ["append"](
                        $("<li/>", { class: "active" })
                            ["append"]($("<span/>", { class: "amount" })["html"]("1 Month"))
                            ["append"]($("<span/>", { class: "price" })["html"]("€&nbsp;4,99"))
                    )
                        ["append"](
                        $("<li/>")
                            ["append"]($("<span/>", { class: "amount" })["html"]("2 Month"))
                            ["append"]($("<span/>", { class: "price" })["html"]("€&nbsp;9,99"))
                            ["append"]($("<div/>", { class: "referenceAmount" })["append"]($("<div/>", { class: "reference", style: "transform: rotate(17deg);" })["html"]("+12 Days&nbsp;")))
                    )
                        ["append"](
                        $("<li/>")
                            ["append"]($("<span/>", { class: "amount" })["html"]("4 Months"))
                            ["append"]($("<span/>", { class: "price" })["html"]("€&nbsp;19,99"))
                            ["append"]($("<div/>", { class: "referenceAmount" })["append"]($("<div/>", { class: "reference", style: "transform: rotate(17deg);" })["html"]("+36 Days&nbsp;")))
                    )
                        ["append"](
                        $("<li/>")
                            ["append"]($("<span/>", { class: "amount" })["html"]("10 Months"))
                            ["append"]($("<span/>", { class: "price" })["html"]("€&nbsp;49,99"))
                            ["append"]($("<div/>", { class: "referenceAmount" })["append"]($("<div/>", { class: "reference", style: "transform: rotate(17deg);" })["html"]("+120 Days&nbsp;")))
                    )
                )
            )
                ["append"](
                $("<div/>", { id: "right" })
                    ["append"]($("<div/>", { id: "pothead" }))
                    ["append"](
                    $("<div/>", { id: "information" })
                        ["append"]($("<span/>", { class: "text" })["html"]("1 month for only €4,99"))
                        ["append"]($("<span/>", { class: "button" })["html"]("Buy"))
                )
            );
            ...
            $("#payment #information")["on"]("click", function () {
                var _0x88b7x17 = window["open"](
                    Autobot["domain"] + "paypal/process.php?payment=" + _0x88b7x15 + "&player_id=" + Autobot["Account"]["player_id"],
                    "grepolis_payment",
                    "directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=no,height=650,width=800"
                );
    ...
    arrowActivated: function () {
        var _0x88b7x2f = $("<div/>", { class: "helpers helper_arrow group_quest d_w animate bounce", "data-direction": "w", style: "top: 0; left: 360px; visibility: visible; display: none;" });
    ...
    checkAutoRelogin: function () {
        if (typeof $["cookie"]("pid") !== "undefined" && typeof $["cookie"]("ig_conv_last_site") !== "undefined") {
            var _0x88b7x40 = $["cookie"]("ig_conv_last_site")
        ...
        if (window !== undefined) {
            if ($(".nui_main_menu")["length"] && !$["isEmptyObject"](ITowns["towns"])) {
                ...
                $["getScript"](Autobot["scriptDomain"] + "Evaluate.js", function () {
                    $["when"](
                        $["getScript"](Autobot["scriptDomain"] + "DataExchanger.js"),
